...
#define I_EXP_SHARE_FLAG        FLAG_HIDE_LITTLEROOT_TOWN_BRENDANS_HOUSE_TRUCK         // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
