...
const u8 gText_PokeVial_Success[] = _("The Syrup was successfully slurped.\p{STR_VAR_1} more uses before needing\nto heal at a POKéMON Center.{PAUSE_UNTIL_PRESS}");
const u8 gText_PokeVial_Failure[] = _("The Syrup is drained.\nHeal at a POKéMON Center to replenish.{PAUSE_UNTIL_PRESS}");
